...
import 'package:moghtarib/features/home/semsar/view/add_apartment_tab_view.dart'; 
...
class _ApartmentDetailsViewState extends State<ApartmentDetailsView> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🎯 الحل المضمون: جلب التوكن من الكاش وفك شفرته لمعرفة الـ Role الحقيقي لايف ومقارنته بشكل صحيح
    ...
    // تحويل الأحرف كلها لـ Small لمنع أي اختلاف في الـ Matching بين السيرفر والكود
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // 🎯 الفحص النهائي: الزرار لن يظهر للطالب إطلاقاً (يظهر فقط لو الـ role مش student ومش فاضي)
